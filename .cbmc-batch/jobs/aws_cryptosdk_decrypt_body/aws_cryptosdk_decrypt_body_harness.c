...
void aws_cryptosdk_decrypt_body_harness() {
    ...
    __CPROVER_assume(props->impl->cipher_ctor == EVP_aes_128_gcm ||
                     props->impl->cipher_ctor == EVP_aes_192_gcm ||
    ...
    if (aws_cryptosdk_decrypt_body(props,
                                   &outp,
                                   &inp,
                                   message_id,
                                   seqno,
                                   ...
                                   content_key,
                                   tag,
                                   body_frame_type) == AWS_OP_SUCCESS) {
        /* TODO */
    }
